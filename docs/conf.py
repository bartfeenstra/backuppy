...
def setup(app):
    ...
    with open(os.path.join(ROOT_PATH, 'docs', 'README.rst'), mode='w+t') as f:
        f.write(readme_rst)


project = 'Backuppy'
copyright = '2018, Bart Feenstra'
...
exclude_patterns = ['modules.rst', 'backuppy*.rst']
...
latex_documents = [
    (master_doc, 'Backuppy.tex', 'Backuppy Documentation',
     'Bart Feenstra', 'manual'),
]
...
man_pages = [
    (master_doc, 'backuppy', 'Backuppy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Backuppy', 'Backuppy Documentation',
     author, 'Backuppy', 'One line description of project.',
     'Miscellaneous'),
]
